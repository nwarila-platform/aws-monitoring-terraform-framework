...
| [repo/0004](repo/0004-encrypt-with-a-supplied-key-when-one-is-named.md) | Encrypt With a Supplied Key When One Is Named | Accepted | 2026-09-23 | Name an existing key by alias and the framework encrypts both topics with it, creating no key, no alias and no key policy; name nothing and it creates and owns one. |
