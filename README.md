...
writes an ARN partition, so the same commit deploys to a commercial or a GovCloud account by
changing only that file. See the [runner protocol](docs/reference/runner-protocol.md).
